  ...
  return (
    ...
    >
      ...
      <div className="bg-blue-50 px-2.5 py-0.5 border-b border-blue-100 flex items-center justify-start text-[8.5px] font-bold text-blue-900">
        <span className="uppercase tracking-wider">Sports Registration Portal</span>
      </div>
      ...
      <div className="px-2.5 py-1 flex gap-2 flex-1 items-stretch min-h-0 w-full overflow-hidden">
        ...
        <div className="w-2/3 min-w-0 flex flex-col justify-center space-y-0.5 py-0.5">
          ...
          <div className="space-y-0.5 text-[9px] text-slate-700">
            {student?.father_name || registration?.father_name ? (
              <div className="truncate"><span className="text-slate-400 font-medium">Father:</span> {student?.father_name || registration?.father_name}</div>
            ) : null}
            <div className="truncate"><span className="text-slate-400 font-medium">Class:</span> {student?.class || registration?.class || '—'}</div>
            <div className="truncate"><span className="text-slate-400 font-medium">Phone:</span> {student?.phone || registration?.phone || '—'}</div>
